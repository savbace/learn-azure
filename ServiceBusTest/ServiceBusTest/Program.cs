...
namespace ServiceBusTest
{
    ...
    class Program
    {
        const string ServiceBusConnectionString = "Endpoint=sb://bboxsb.servicebus.windows.net/;SharedAccessKeyName=ConsoleTest;SharedAccessKey=j2OjoQFl/nWrOYF8k547+ZnM4KedLN3xHXstsfGQGmo=";
        ...
        public static async Task Main(string[] args)
        {
            ...
            {
                string subscriptionName = args[2];
        ...
        private static async Task SendMessagesAsync(int numberOfMessagesToSend)
        {
            try
            {
                for (var i = 0; i < numberOfMessagesToSend; i++)
                {
                    ...
                    string messageBody = $"Message {i} at {DateTime.UtcNow}";
